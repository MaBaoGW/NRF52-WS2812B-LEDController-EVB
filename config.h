...
#define NUM_LEDS		500		// Total number of LEDs on the strip
#define MAX_BRIGHTNESS		64		// Maximum value of a single color (255 for WS2812B/WS2813)
...
#define DEMO_PERIOD 		15000	// How long each complete rainbow demo last
